...
//Contrutor 
Rede::Rede(int m, double mmean, double ssigma, double kk, int tp, double HH, unsigned int seed) : no(2), s(m, 1.0), n(m), mean(mmean), sigma(ssigma), k(kk), type(tp), H(HH), nbonds(n*(n-1)/2), J(nbonds, 0.0), h(m, 0.0), nb(n*(n-1)), s_nb(n*(n-1)) {
