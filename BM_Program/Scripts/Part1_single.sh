...
if [ "$test" = "true" ]; then
    ...
    #sisj
    paste $path_in'sisj-exp/tests/sisj_ep_'$1'_j_'$2'_h_'$3'.dat' $path_in'sisj-ising/tests/sisj_ising_'$1'_j_'$2'_h_'$3'.dat' | sed 's/\t/ /g' > $path_out'sisj/tests/sisj_exp_ising_'$1'_j_'$2'_h_'$3'.dat'
...
# Else: create final file
    ...
    #sisj
    paste $path_in'sisj-exp/sisj_ep_'$1'.dat' $path_in'sisj-ising/sisj_ising_'$1'.dat' | sed 's/\t/ /g' > $path_out'sisj/sisj_exp_ising_'$1'.dat'
    ...
    #sisjsk
    paste $path_in'sisjsk-exp/sisjsk_exp_'$1'.dat' $path_in'sisjsk-ising/sisjsk_ising_'$1'.dat' | sed 's/\t/ /g' > $path_out'sisjsk/sisjsk_exp_ising_'$1'_j_'$2'_h_'$3'.dat'
fi